...
public class ShapeTest
{
    ...
    public void TriangleTest()
    {
        ...
        Assert.assertEquals("EquilateralTriangle area incorrect.", (3.0 * 3.0 * (Math.sqrt(3) / 4)), tri.getArea(),
                0.0001);
    ...
    public void EllipseTest()
    {
        ...
        Ellipse circ2 = new Ellipse("Ellipse1", 3.0, 3.0);
        Assert.assertEquals("Incorrect minor axis", new Double(3.0), new Double(circ2.getMinorAxis()));
    }
    ...
    public void NaturalCompareTest()
    {
        ...
        // Testing if Branch
        Assert.assertEquals("Shape compareTo gave incorrect ordering.", -1, sq.compareTo(rect));
        Assert.assertEquals("Shape compareTo gave incorrect ordering.", 1, rect.compareTo(sq));
        ...
        // Testing else branch
        Assert.assertEquals("Shape compareTo failed to find shapes that are equal ", 0, sq2.compareTo(sq2));
