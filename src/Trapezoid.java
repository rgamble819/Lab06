...
public class Trapezoid extends Polygon
{
     ...
     * @param leftSide
     *            The left side (not parallel) of the trapezoid.
     * @param rightSide
     *            The right side (not parallel) of the trapezoid.
     * @param topBase
     *            The top base (parallel to the bottom base) of the trapezoid.
     * @param bottomBase
     *            The bottom base (pallel to the top base) of the trapezoid.
     */
